...
public partial class App : Application
{
    ...
    public App()
    {
        ...
        ConfigureServices((context, services) =>
        {
            ...
            services.AddTransient<UtilisateurPage>();
            services.AddTransient<SerieViewModel>();
            services.AddTransient<SeriePage>();
